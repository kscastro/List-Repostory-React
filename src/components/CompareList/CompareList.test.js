...
const repositories = [
  {
    ...
    updated_at: '2019-03-17T23:12:43Z',
    pushed_at: '2019-03-17T16:17:05Z',
    ...
    size: 141097,
    stargazers_count: 124595,
    watchers_count: 124595,
    language: 'JavaScript',
    has_issues: true,
    has_projects: true,
    has_downloads: true,
...
it('should render Comparelist', () => {
  const wrapper = shallow(<CompareList repositories={repositories} />);
